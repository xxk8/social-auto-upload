...
if OLD4 in src:
    ...
    print(f"EDIT 4: guarded save_data_url_image with if qrcode_src (HIGH-1 fix)")
else:
...
if OLD5 in src:
    ...
    print(f"EDIT 5: cookie_auth goto wrapped with try/except (HIGH-2 fix)")
else:
...
if OLD6 in src:
    ...
    print(f"EDIT 6: DouYinVideo.upload goto wrapped with try/except (HIGH-2 fix)")
else:
...
if OLD7 in src:
    ...
    print(f"EDIT 7: DouYinNote.upload goto wrapped with try/except (HIGH-2 fix)")
else:
