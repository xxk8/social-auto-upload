    ...
    useImperativeHandle(
      ...
      () => ({
        applyAiResult(result) {
          ...
          if (result.tags && (Array.isArray(result.tags) ? result.tags.length > 0 : String(result.tags).length > 0)) setTags(Array.isArray(result.tags) ? result.tags : String(result.tags).split(/[,，\s]+/).filter(Boolean))
        },
